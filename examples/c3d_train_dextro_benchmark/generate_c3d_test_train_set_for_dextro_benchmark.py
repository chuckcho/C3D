...
def main():
    ...
    '''
    print "[debug] !!!!! #1: all_content_type_ids={}".format(all_content_type_ids)
    print "[debug] !!!!! #1: num_videos_per_content_type={}".format(num_videos_per_content_type)
    ...
    num_videos_per_content_type = Counter(all_content_type_ids)
    print "[debug] !!!!! #2: all_content_type_ids={}".format(all_content_type_ids)
    print "[debug] !!!!! #2: num_videos_per_content_type={}".format(num_videos_per_content_type)
    '''
